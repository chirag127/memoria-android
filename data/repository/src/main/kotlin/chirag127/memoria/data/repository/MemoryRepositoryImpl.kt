...
class MemoryRepositoryImpl
    ...
    constructor(
        ...
        override fun observeRecent(limit: Int): Flow<List<Memory>> = dao.observeRecent(limit).map { list -> list.map { it.toMemory() } }
        ...
        private fun appLocalFallback(): File = File(System.getProperty("java.io.tmpdir") ?: ".", "memoria-vault").apply { mkdirs() }
...
private fun String.toMemoryType(): MemoryType = runCatching { MemoryType.valueOf(uppercase()) }.getOrDefault(MemoryType.INBOX)
